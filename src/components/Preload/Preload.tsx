...
.preload-logo-ring-outer {
    stroke-dasharray: 801;
    stroke-dashoffset: 801;
    animation: drawOuter 4s ease-in-out 2s both;
}
.preload-logo-ring-inner {
 stroke-dasharray: 0 731;
    stroke-dashoffset: 0;
	  transform-origin: center;
	  transform-box: fill-box;
    animation: drawInnerReverse 4s ease-in-out 2s both;
}
			`}</style>

				<circle
					className="preload-logo-ring-outer"
					cx="130"
					cy="130"
					r="127.5"
					stroke="currentColor"
				...
				/>
				<circle
					className="preload-logo-ring-inner"
					cx="129.998"
					cy="129.998"
					r="116.26"
					stroke="currentColor"
